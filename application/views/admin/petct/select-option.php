                        ...
                        <div class="row">
                            <form class="insert_data_super_admin" this_id="form-9900" reload-action="true">
								...
								<div class="col-md-12">
									...
									<select type="text" name="negative_id" required class="form-control">
										<option value="0"> -- Select Template Name -- </option>
										<?php foreach ($this->common_model->get_records('tbl_petct_template', "status='0' and template_id='$input_id'") as $template_name) : ?>
											<option  value="<?= $template_name->id ?>"><?= $template_name->negative_finding ?></option>
										<?php endforeach; ?>
									</select>
									<span class="text-danger error-span">This input is required.</span>
								</div>
                        ...
                        <table class="table table-hover data_table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Negative</th>
									<!--<th>Negative Finding Answer</th>
                                    <th>Negative Impression Answer</th>-->
                                    <th>Score</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
											...
											<!--<td>
                                                <?= $record->negative_finding_text ?>
                                            </td>
											<td>
                                                <?= $record->negative_impression_text ?>
                                            </td>-->
											<td>
                                                <?= $this->common_model->get_record('tbl_petct_template', "status='0' and id='$record->negative_id'", "negative_finding"); ?>
                                            </td>
											<td>
                                                <?= $record->score ?>
                                            </td>
                                            ...
                                            <td class="text-center" style="display: flex;justify-content: center">
                                                <a class="btn btn-sm btn-warning" style="margin-right: 5px;" data-toggle="modal" data-target="#modal-default" onclick="$('.update_data_option input[name=row_id]').val(`<?= $record->id ?>`);$('.update_data_option input[name=name]').val(`<?= $record->name ?>`);$('.update_data_option select[name=negative_id]').val(`<?= $record->negative_id ?>`);$('.update_data_option textarea[name=finding_text]').val(`<?= $record->finding_text ?>`);$('.update_data_option textarea[name=impression_text]').val(`<?= $record->impression_text ?>`);$('.update_data_option input[name=input_id]').val(`<?= $record->input_id ?>`);$('.update_data_option input[name=score]').val(`<?= $record->score ?>`);"><i class="fa fa-pencil-square-o"></i></a>
