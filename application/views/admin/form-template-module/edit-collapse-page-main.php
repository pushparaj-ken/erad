<div class="row">
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			<select class="form-control select22" name="select_fields_id_sub[]" multiple="multiple" data-placeholder="Select a Hide Items" required style="width: 100%;">
	...
	<!--<div class="col-md-12">
		<div class="form-group">
			...
			<select class="form-control select22" name="select_fields_id_child[]" multiple="multiple" data-placeholder="Select a Hide Items" required style="width: 100%;">
