		...
		<div class="row">		
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form class="insert_collapse_items_sub" this_id="form-9900" reload-action="true">
								<div class="col-md-6">
								...
								?>
										<tr>
											...
											<td class="text-center" style="display: flex;justify-content: center">
												<span class="btn btn-sm btn-warning" onclick="edit_collapse_sub(<?= $record->id ?>,<?= $record->template_id ?>,<?= $record->input_id ?>);">
													<i class="fa fa-edit"></i>
												</span>
												<form class="update_data" this_id="form-<?= uniqid() ?>" reload-action="true">
                                                    <input type="hidden" name="row_id" value="<?= $record->id ?>">
                                                    <input type="hidden" name="status" value="1">
                                                    <input type="hidden" name="table_name" value="tbl_collapse_section_sub">
...
<div class="modal fade" id="modal-default">
	<div class="modal-dialog">
		<div class="modal-content">
			<form reload-action="true" this_id="form-002" class="update_collapse_items_sub" method="post" role="form">
...
<script>
function edit_collapse_sub(row_id,template_id,input_id)
{
	$.ajax({
		type: 'POST',
		url: baseURL + "admin/edit_collapse_sub",
...
$('body').on("submit", '.insert_collapse_items_sub', function(e) {
    e.preventDefault();
    ...
    if (is_required(this_id) === true) {
        $.ajax({
            type: 'POST',
            url: baseURL + "admin/insert_collapse_items_sub",
...
$('body').on("submit", '.update_collapse_items_sub', function(e) {
    e.preventDefault();
    ...
    if (is_required(this_id) === true) {
        $.ajax({
            type: 'POST',
            url: baseURL + "admin/update_collapse_items_sub",
            data: new FormData(this),
            dataType: "json",
            contentType: false,
            processData: false,
