...
<div class="content-wrapper">
    <section class="content">
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- form start -->
                                ...
                                <div class="box-body">
                                    <div class="row">
										<?php 
											$assign_scribe = $this->common_model->get_records('tbl_users', "isDeleted='0' and roleId = '3'")[0]; 
										//foreach($assign_exit_id as $assign_scribe) { ?>
										<?php if($this->common_model->get_record('tbl_template_logs', "status='0' and template_form_id='$temp_id->id' and assign_id ='$assign_scribe->userId'","answer_name") == "" && $this->common_model->get_record('tbl_template_logs', "status='0' and template_form_id='$temp_id->id' and assign_id ='$assign_scribe->createdBy'","main_title") == ""){ ?>
										<?php 
											$template = $this->common_model->get_records('tbl_template_logs', "status='0' and template_form_id='$temp_id->id' and assign_id ='$assign_scribe->userId' group by order_by"); 
											foreach($template as $order) {
										?>
										...
										<h3>
											...
											<?php endif;?>
										<?php foreach($this->common_model->get_records('tbl_template_logs', "status='0' and template_form_id='$temp_id->id' and assign_id ='$assign_scribe->userId' and order_by = '$order->order_by'") as $template_field) { ?>
											<?php if ($template_field->type == 10 ) { ?>
												<div class="col-md-11">
													<div class="form-group" id="<?= $template_field->id ?>">
														<label for="exampleInputEmail1"><?= $template_field->name ?></label>
														<select type="text" class="form-control" name="techniques[]" id="<?= $template_field->form_fields_id ?>">
															<option value="">-- Select --</option>
															<?php foreach ($this->common_model->get_records('tbl_copy_input_options', "status='0' and input_id='$template_field->label_id' and assign_id ='$assign_scribe->userId'") as $options) : ?>
																<option value="<?= $options->name ?>"><?= $options->name ?></option>
															<?php endforeach; ?>
														</select>
													</div>
										...
										<?php } }} ?> 
									<?php } elseif ($this->common_model->get_record('tbl_template_logs', "status='0' and template_form_id='$temp_id->id' and assign_id ='$assign_scribe->userId'","answer_name") != "" && $this->common_model->get_record('tbl_template_logs', "status='0' and template_form_id='$temp_id->id' and assign_id ='$assign_scribe->userId'","main_title") == ""){?>
										...
										?>
											...
											<div class="col-md-11">
												<div class="form-group" id="<?= $template_field->id ?>">
													...
													<select type="text" class="form-control" name="techniques[]" id="<?= $template_field->form_fields_id ?>">
														<option value="">-- Select --</option>
														<?php foreach ($this->common_model->get_records('tbl_template_logs', "status='0' and label_id='$template_field->label_id' and assign_id ='$assign_scribe->userId'") as $options) : ?>
									...
									<?php } elseif ($this->common_model->get_record('tbl_template_logs', "status='0' and template_form_id='$temp_id->id' and assign_id ='$assign_scribe->userId'","answer_name") == ""  && $this->common_model->get_record('tbl_template_logs', "status='0' and template_form_id='$temp_id->id' and assign_id ='$assign_scribe->userId'","main_title") != "" )  {  ?>
										<div class="col-md-12">
											<div class="form-group">
												...
												<select class="form-control"  name="template_form_id"  >
													<option value="">Select template</option>
													<?php 
														$template = $this->common_model->get_records('tbl_template_logs', "status='0' and template_form_id='$temp_id->id' and assign_id ='$assign_scribe->userId'"); 
										...
										<div class="col-md-12">
											<div class="form-group">
												<label for="title">Name</label>
												<input type="text" class="form-control" name="title" value = "<?=$this->common_model->get_record('tbl_template_logs', "status='0' and template_form_id='$temp_id->id' and assign_id ='$assign_scribe->userId'","main_title")?>">
												<input type="hidden" name="row_id" value="">
												<input type="hidden" name="label_id" value="">
												<input type="hidden" name="table_name" value="tbl_main_title">
												<input type="hidden" name="updated_by" value="<?= $_SESSION['userId']; ?>">
		...
		<form class="change-template-admin">
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
...
<script>
	...
	$('body').on("submit", '.change-template-admin', function(e){
		e.preventDefault();
		
		$.ajax({
			type: 'POST',
			url: baseURL + "admin/approve-change-template-admin",
